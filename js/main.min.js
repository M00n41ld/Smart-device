...
var buttonModal = document.querySelector('.header__order-call');
var accordion = document.querySelectorAll('.accordion__element');
var buttonMore = document.querySelector('.about__button');
var lastParagraph = document.querySelector('.about__text--target');
var mobileParagraph = document.querySelector('.about__text--target-mobile');
...
accordion.forEach(function (element) {
  return element.classList.remove('accordion__element--nojs');
});
